                ...
                <div class="row justify-content-md-between">
                    <div class="col-sm-4 col-lg-2 mb-4 mb-lg-0">
                        ...
                        <ul class="list-group list-group-flush list-group-borderless mb-0">
                            ...
                            <li><a class="list-group-item list-group-item-action"
                                    href="../pages/services-agency.html">Services</a></li>
                            <li><a class="list-group-item list-group-item-action"
                                    href="../pages/careers.html">Careers</a></li>
                        </ul>
                        <!-- End List Group -->
                    ...
                    <div class="col-sm-4 col-lg-2 mb-4 mb-lg-0">
                        ...
                        <!-- List Group -->
                        <ul class="list-group list-group-flush list-group-borderless mb-0">
                            <li><a class="list-group-item list-group-item-action" href="../pages/help.html">Help</a>
                            </li>
                            <li><a class="list-group-item list-group-item-action" href="../pages/terms.html">Terms</a>
                            </li>
                            <li><a class="list-group-item list-group-item-action"
                                    href="../pages/privacy.html">Privacy</a></li>
                        </ul>
                        <!-- End List Group -->
                    </div>

                    <div class="col-md-6 col-lg-4">
                        <h4 class="h6 font-weight-semi-bold mb-4">We are driven to deliver results for all your
                            businesses.</h4>

                        <!-- Button -->
                        <button type="button"
                            class="btn btn-xs btn-dark btn-wide transition-3d-hover text-left mb-2 mr-1">
        ...
        <div class="container text-center space-1">
            ...
            <a class="d-inline-flex align-items-center mb-2" href="../home/index.html" aria-label="Front">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    width="36px" height="36px" viewBox="0 0 46 46" xml:space="preserve" style="margin-bottom: 0;">
                    <path fill="#3F7DE0" opacity=".65"
                        d="M23,41L23,41c-9.9,0-18-8-18-18v0c0-9.9,8-18,18-18h11.3C38,5,41,8,41,11.7V23C41,32.9,32.9,41,23,41z" />
                    <path class="fill-info" opacity=".5"
                        d="M28,35.9L28,35.9c-9.9,0-18-8-18-18v0c0-9.9,8-18,18-18l11.3,0C43,0,46,3,46,6.6V18C46,27.9,38,35.9,28,35.9z" />
            ...
            <div class="u-sidebar__container">
                    ...
                    <div class="js-scrollbar u-sidebar__body">
                        ...
                        <header class="d-flex align-items-center u-sidebar--account__holder mt-3">
                            ...
                            <div class="ml-3">
                                ...
                                @else
                                <span
                                    class="font-weight-semi-bold">{{ Auth::user()->pendaftaran->nama_mahasiswa}}</span>
                                @endif
                ...
                <footer id="SVGwaveWithDots" class="svg-preloader u-sidebar__footer u-sidebar__footer--account">
                    ...
                    <div class="position-absolute right-0 bottom-0 left-0">
                        <img class="js-svg-injector" src="{{ asset('front/svg/components/wave-bottom-with-dots.svg') }}"
                ...
                <form class="js-validate js-step-form" data-progress-id="#progressStepForm"
                    ...
                    <div id="contentStepForm" class="p-5">
                            ...
                            <div id="recentPayersList" data-target-group="idAddNewPayer">
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    <a class="js-animation-link d-inline-block small link-muted" href="javascript:;"
                                        data-target="#addNewPayer" data-link-group="idAddNewPayer">
                                ...
                                <div class="mb-4">
                                    <input class="form-control" type="email" placeholder="Enter email, name, or company"
                                        aria-label="Enter email, name, or company">
                                </div>
                                <!-- End Add Members -->
                                    ...
                                    <a class="card card-frame mb-2" href="javascript:;"
                                        ...
                                        <div class="card-body align-items-sm-center p-2">
                                            <div class="media align-items-center">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid rounded-circle"
                                                        src="{{ asset('front/img/100x100/img8.jpg') }}"
                                                        alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <h4 class="h6 mb-0">Sebastian Diaz</h4>
                                                    <small
                                                        class="d-block text-secondary">sebastiandiaz@gmail.com</small>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a class="card card-frame mb-2" href="javascript:;"
                                        ...
                                        <div class="card-body align-items-sm-center p-2">
                                            <div class="media align-items-center">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid rounded-circle"
                                                        src="{{ asset('front/img/100x100/img12.jpg') }}"
                                                        alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                    ...
                                    <a class="card card-frame mb-2" href="javascript:;"
                                        ...
                                        <div class="card-body align-items-sm-center p-2">
                                            <div class="media align-items-center">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid rounded-circle"
                                                        src="{{ asset('front/img/100x100/img10.jpg') }}"
                                                        alt="Image Description">
                                                </div>
                                                <div class="media-body">
                        ...
                        <div id="attachDocumentsStep" style="display: none;">
                            ...
                            <!-- Buttons -->
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1">Request
                                    Payment</button>
                                <a class="btn btn-sm btn-soft-secondary transition-3d-hover mr-1" href="javascript:;"
