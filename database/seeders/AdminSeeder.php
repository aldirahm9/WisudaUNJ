...
class AdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Fakultas::create([
            'nama_fakultas' => 'FIO',
            'tanggal_awal_photoshoot' => '2020-10-29',
        ...
        Fakultas::create([
            ...
            'tanggal_akhir_photoshoot' => '2020-11-13',
        ]);
        Fakultas::create([
            'nama_fakultas' => 'FIP',
            'tanggal_awal_photoshoot' => '2020-11-16',
            'tanggal_akhir_photoshoot' => '2020-11-18',
        ]);
        Fakultas::create([
            'nama_fakultas' => 'FE',
            'tanggal_awal_photoshoot' => '2020-11-19',
