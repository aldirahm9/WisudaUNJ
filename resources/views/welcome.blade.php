...
<head>
  ...
  <meta property="og:url" content="https://wisudadigitalunj.id">
  ...
  <meta property="og:image" content="{{ asset('logounj.png') }}">

  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image">
  <meta property="twitter:url" content="https://wisudadigitalunj.id">
  ...
  <meta property="twitter:image" content="{{ asset('logounj.png') }}">
